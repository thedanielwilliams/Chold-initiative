...
ORG_JSONLD = {
    ...
    "sameAs": [
        "https://www.linkedin.com/company/chold-initiative",
        "https://www.instagram.com/chold_initiative",
        "https://x.com/choldinitiative"
    ],
}
...
<meta property="og:image:alt" content="Map of Nigeria with the CHOLD Initiative wordmark">
      ...
      <div>
        <div class="footer-brand">
          ...
          <div>
            ...
            <div class="s">Registered 2018 &middot; Livestock focus since 2025 &middot; Abuja, Nigeria</div>
          </div>
        </div>
        ...
        <div class="social">
          ...
          <a href="https://x.com/choldinitiative" aria-label="CHOLD Initiative on X (formerly Twitter)" rel="noopener" target="_blank"><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17.5 3h3.1l-6.8 7.8L21.8 21h-6.2l-4.9-6.4L5.1 21H2l7.3-8.3L2.4 3h6.4l4.4 5.8Zm-1.1 16.1h1.7L7.7 4.8H5.9Z"/></svg></a>
        </div>
      </div>
